function cardMoto (moto){
    return `<div class="card">
                ...
                <div class="card-button">
                    <button class="button button-outline button-add" id="${motos.id}" title="Clic para agregar al carrito">+</button>
                </div>
            </div>` 
}
...
function cardCasco (casco){
    return `<div class="card">
                ...
                <div class="card-button">
                    <button class="button button-outline button-add" id="${cascos.id}" title="Clic para agregar al carrito">+</button>
                </div>
            </div>` 
}

function cardGuantes (guante){
    return `<div class="card">
                ...
                <div class="card-button">
                    <button class="button button-outline button-add" id="${guantes.id}" title="Clic para agregar al carrito">+</button>
                </div>
            </div>` 
}
